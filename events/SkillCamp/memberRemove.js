...
module.exports = {
	...
	execute(member) {
		...
		// TODO if member was banned
		// RESEARCH https://discord.js.org/#/docs/main/main/class/Guild?scrollTo=bans
		...
		if (kickedUser) {
			...
			embed.addFields(
				{ name: 'Reason', value: kickedUser.reason },
				{ name: 'Kicked By', value: kickedUser.bannedBy },
			);
